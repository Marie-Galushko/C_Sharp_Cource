...
int row = int.Parse(coord[0]); // вводим значения кол-ва строк (полученных от пользователя)
int column = int.Parse(coord[1]); // вводим значения кол-ва столбцов (полученных от пользователя)
